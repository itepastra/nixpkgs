...
[
  ...
  (fetchNuGet {
    ...
    version = "12.14.1";
    hash = "sha256-5HtijBNuV5RIg6MmU+xaeBuyfu7lu93dwv+fe2zU8sw=";
  })
  (fetchNuGet {
    pname = "Azure.Storage.Common";
    version = "12.13.0";
    hash = "sha256-bi+rIM+7lgbrU8mOxYy0R+0tvYIe3MMUX9UuhbNfzxo=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "7.5.1";
    hash = "sha256-WykYJpzRtoBaJxQth+euthUi9l2zwT1k7MIXwWdTeAs=";
  })
  (fetchNuGet {
    pname = "Microsoft.IdentityModel.Protocols.OpenIdConnect";
    version = "7.5.1";
    hash = "sha256-1TO55DCgFxB8kzBdqwS58WK7mTyw+iOYQc8ZsCoDOKM=";
  })
  (fetchNuGet {
  ...
  (fetchNuGet {
    ...
    version = "7.5.1";
    hash = "sha256-o1hxAT1gKqTGTlTHEMMcHmjn7RjtbACA0X99VBaH8cI=";
  })
  (fetchNuGet {
