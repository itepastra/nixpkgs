  ...
  config = lib.mkIf cfg.enable {
    assertions = [
      ...
      (assertRemovedOption [
        "settings"
        "acl_policy_path"
      ] "Use `policy.path` instead.")
      (assertRemovedOption [
        "settings"
        "db_host"
      ] "Use `database.postgres.host` instead.")
      (assertRemovedOption [
        "settings"
        "db_name"
      ...
      (assertRemovedOption [
        "settings"
        "db_path"
      ] "Use `database.sqlite.path` instead.")
      (assertRemovedOption [
        "settings"
        "db_port"
      ] "Use `database.postgres.port` instead.")
      (assertRemovedOption [
        "settings"
        "db_type"
      ] "Use `database.type` instead.")
      (assertRemovedOption [
        "settings"
        "db_user"
      ] "Use `database.postgres.user` instead.")
      (assertRemovedOption [
        "settings"
        "dns_config"
      ] "Use `dns` instead.")
      (assertRemovedOption [
        ...
        "dns_config"
        "domains"
      ] "Use `dns.search_domains` instead.")
      (assertRemovedOption [
        "settings"
        "dns_config"
        "nameservers"
